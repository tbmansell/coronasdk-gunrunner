...
EnemyDefs = {
    ...
    heavy = {
        ...
        [reptileFlamer] = {
            [normal]  = {skin="reptile_runner_captain",  weapon="flamer",   health=5, decisionDelay=500,  aggression=50, fidgit=90, roaming=2000, speed=200, melee=true, scale=0.4, json="reptiles-flamer"},
        }
    },
    turret = {
        [turretChainGun] = {
